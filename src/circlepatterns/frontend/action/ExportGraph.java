 ...
 */
public class ExportGraph extends AbstractAction {
	...
	public ExportGraph(Component parent, ExtensionFileFilter filter) {
		this.parent  = parent;
		this.filter = filter;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (result == JFileChooser.APPROVE_OPTION){
			...
			try {
				...
				writer.writeHalfEdgeDataStructure(CPTestSuite.getTopology());
			} catch (Exception e1) {
