...
public class TetrahedronWankelDeformOptions extends JDialog implements ActionListener {

	private JButton 
		okBtn = new JButton("Generate"),
		cancelBtn = new JButton("Cancel");
	private SpinnerNumberModel
		segmentsModel = new SegmentsModel();
	private JSpinner 
	...
	public TetrahedronWankelDeformOptions(JFrame owner, String title) {
		super(owner);
		setTitle(title);
		initialize();
		if (owner != null){
