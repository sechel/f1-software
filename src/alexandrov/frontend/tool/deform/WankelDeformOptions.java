...
public class WankelDeformOptions extends JDialog implements ActionListener {
	...
	public WankelDeformOptions(JFrame owner, String title) {
		super(owner);
		setTitle(title);
		initialize();
		if (owner != null){
	...
	public Integer getTwist(){
		return twistModel.getNumber().intValue();
	}
