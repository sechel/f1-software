...
/**
 * The about box for the koebe polyhedron editor
 * <p>
...
public class AboutBox extends JDialog {
	...
	private Icon 
		f1LogoIcon = new ImageIcon(ImageHook.getImage("f1logo.png"));
	private JLabel
		f1Logo = new JLabel(f1LogoIcon),
		title = new JLabel("Project MATHEON F1"),
		label1 = new JLabel("Leader: Prof. Alexander I. Bobenko"),
		label2 = new JLabel("Project: Dr. Boris Springborn"),
		label3 = new JLabel("Program: Stefan Sechelmann");
	...
	public AboutBox(JFrame owner){
		...
		setResizable(false);
		setModal(true);
		setTitle("About Koebes Polyhedron Editor");
		makeLayout();
