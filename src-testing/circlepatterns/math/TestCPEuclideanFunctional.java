...
public class TestCPEuclideanFunctional extends TestCase {
	...
	public void testGradient() throws Exception {
		...
		CPEuclideanOptimizable<CPVertex, CPEdge, CPFace> functional = new CPEuclideanOptimizable<CPVertex, CPEdge, CPFace>(ds);
